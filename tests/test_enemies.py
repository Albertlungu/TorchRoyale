...
Usage:
  python tests/test_enemies.py data/replays/Game_23.mp4
  python tests/test_enemies.py data/replays/Game_23.mp4 --start 1000 --stride 120 --conf 0.1
  python tests/test_enemies.py data/replays/Game_23.mp4 --weights data/models/onfield/torchroyale-enemies-best.pt
"""
...
_OUTPUT_DIR = Path("output/test_enemies_hero_knight_only")
_DEFAULT_WEIGHTS = Path(
    "data/models/onfield/torchroyale-enemies-hero-knight-only/weights/best.pt"
)
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Enemies model smoke test.")
    parser.add_argument("video", help="Path to input video file.")
    parser.add_argument(
        "--weights",
        default=str(_DEFAULT_WEIGHTS),
        help="Path to enemies .pt weights file.",
    )
...
def main() -> None:
    ...
    print(f"Loading Enemies model from {weights_path}...")
