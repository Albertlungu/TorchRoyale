...
Defines the top bar and tabbed interface (Logs, Visualize, Settings).
"""
...
def setup_top_bar(main_window) -> QFrame:
    """Create the top bar with project title and controls."""
    top_bar = QFrame()
    ...
    server_details = QLabel("Decision Transformer for Clash Royale")
...
def setup_tabs(main_window) -> QTabWidget:
    """Create the tabbed interface with Logs, Visualize, and Settings."""
    ...
    ingame_group = QGroupBox("In-Game Settings")
