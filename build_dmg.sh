...
curl -L "https://github.com/astral-sh/python-build-standalone/releases/download/20260504/cpython-3.10.20+20260504-aarch64-apple-darwin-install_only.tar.gz" -o pbs.tar.gz
tar -xf pbs.tar.gz
rm pbs.tar.gz
